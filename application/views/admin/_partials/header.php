...
<head>
    ...
    <!-- Custom CSS -->
    <link href="<?php echo base_url();?>assets/admin/vendor/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Custom Fonts -->
    <link href="<?php echo base_url();?>assets/admin/vendor/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <!-- Date Picker -->
    <link href="<?php echo base_url();?>assets/admin/vendor/datepicker/css/bootstrap-datepicker.css" rel="stylesheet" type="text/css">
    ...
    <link href="<?php echo base_url();?>assets/admin/css/dataTables/jquery.dataTables.css" rel="stylesheet">
