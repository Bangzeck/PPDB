...
<form action="<?php echo base_url('admin/siswa/add'); ?>" method="post" role="form">
        ...
        <div class="col-xs-12">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="100" type="text" name="nama_siswa" required="required" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input maxlength="100" type="text" name="tempat_lahir" required="required" class="form-control"
                        placeholder="Tempat Lahir" />
                </div>
                <div class="form-group">
                    <label class="control-label">Tanggal Lahir :</label>
                    <input maxlength="100" type="date" name="tanggal_lahir" required="required"
                        class="date form-control" placeholder="Contoh : 1996-05-08" />
                </div>
                <div class="form-group">
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="200" type="text" name="nama_ayah" required="required" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input maxlength="200" type="text" name="nomor_ayah" required="required" class="form-control"
                        onKeyPress="return hanyaAngka(event);" placeholder="Masukan Nomor Handphone" />
                </div>
                <div class="form-group">
                    <label class="control-label">Nama Ibu : </label>
                    <input maxlength="200" type="text" name="nama_ibu" required="required" class="form-control"
                ...
                <div class="form-group">
                    ...
                    -<input maxlength="100" type="text" name="nomor_ibu" required="required" class="form-control"
                        onKeyPress="return hanyaAngka(event);" placeholder="Masukkan Nomor Handphone" />
                </div>
                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
            </div>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="200" type="text" name="nama_wali" required="required" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input maxlength="100" type="text" name="nomor_wali" required="required" class="form-control"
                        onKeyPress="return hanyaAngka(event);" placeholder="Masukkan Nomor Handphone" />
                </div>
                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
            </div>
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="200" type="text" name="npsn_sekolah" required="required" class="form-control"
                        placeholder="Masukkan Nomor NPSN Sekolah" onKeyPress="return hanyaAngka(event);" />
                </div>
                <div class="form-group">
                    <label class="control-label">Asal Sekolah :</label>
                    <input maxlength="200" type="text" name="nama_sekolah" required="required" class="form-control"
                ...
                <div class="form-group">
                    ...
                    <input maxlength="200" type="text" name="tahun_lulus" required="required" class="form-control"
        ...
        <div class="col-xs-12">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input maxlength="200" type="text" name="ipa" required="required" class="form-control"
                        placeholder="Masukkan Nilai" onKeyPress="return hanyaAngka(event);" />
                </div>
                <div class="form-group">
                    <label class="control-label">Matematika</label>
                    <input maxlength="200" type="text" name="matematika" required="required" class="form-control"
                        placeholder="Masukkan Nilai" onKeyPress="return hanyaAngka(event);" />
                </div>
                <div class="form-group">
                    <label class="control-label">Bahasa Indonesia</label>
                    <input maxlength="200" type="text" name="indo" required="required" class="form-control"
                        placeholder="Masukkan Nilai" onKeyPress="return hanyaAngka(event);" />
                </div>
                <div class="form-group">
                    <label class="control-label">Bahasa Inggris</label>
                    <input maxlength="200" type="text" name="inggris" required="required" class="form-control"
                        placeholder="Masukkan Nilai" onKeyPress="return hanyaAngka(event);" />
                </div>
                <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
            </div>
