...
<div class="panel panel-default ">
    <div class="panel-heading">
        ...
        <h4 style="font-family:roboto; font-weight:bold">TAMBAH SISWA</h4>
    </div>
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="100" type="text" name="nomor_wali" required="required"
                                class="form-control" onKeyPress="return hanyaAngka(event);"
                                placeholder="Masukkan Nomor Handphone" />
                        </div>
                        <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="200" type="text" name="tahun_lulus" required="required"
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input maxlength="200" type="text" name="matematika" required="required"
