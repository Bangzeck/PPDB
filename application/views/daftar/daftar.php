            ...
            <div class="col-xs-12">
                <div>
                    ...
                    <div class="form-group col-md-2 ">
                        ...
                        <input type="text" name="nisn" value="<?php echo $c->kode ?>" class="form-control kunci"
                            placeholder="Masukkan NISN" onKeyPress="return hanyaAngka(event);" readonly />
                        <?php endforeach; ?>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input maxlength="14" type="text" name="nomor_siswa" class="form-control"
                            onKeyPress="return hanyaAngka(event);" required="required"
            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input maxlength="100" type="text" name="nomor_wali" class="form-control"
                            onKeyPress="return hanyaAngka(event);" placeholder="Masukkan Nomor Handphone" />
                    </div>
                    <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input maxlength="3" type="text" name="bahasa_indonesia" required="required"
                            class="form-control" placeholder="Masukkan Nilai" onKeyPress="return hanyaAngka(event);" />
                    </div>
                    <div class="form-group col-md-6">
