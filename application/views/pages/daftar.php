...
<div class="container">
    ...
    <form action="<?php echo base_url('admin/siswa/addPeserta'); ?>" method="post" role="form">
            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="100" type="text" name="nama_siswa" required="required" class="form-control" placeholder="Nama Siswa" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Jenis Kelamin :</label>
                        <select style="height:35px" class="form-control" name="jenis_kelamin" type="text" name="jenis_kelamin" id="jenis_kelamin"
                            required>
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="100" type="text" name="tempat_lahir" required="required" class="form-control" placeholder="Tempat Lahir" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <select style="height:35px" class="form-control" name="agama" id="" required type="text">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="alamat_siswa" name="alamat_siswa" class="form-control" maxlength="100" minlength="3"
                            rows="3" required="required" placeholder="Masukan Alamat Siswa"></textarea>

                    </div>
                    <div class="form-group">
                        <label class="control-label">No . HP Siswa :</label>
                        <input maxlength="100" type="text" name="nomor_siswa" class="form-control" onKeyPress="return hanyaAngka(event);"
            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="200" type="text" name="nama_ayah" required="required" class="form-control" placeholder="Nama Ayah" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="200" type="text" name="nomor_ayah" required="required" class="form-control" onKeyPress="return hanyaAngka(event);"
                            placeholder="Masukan Nomor Handphone" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Nama Ibu : </label>
                        <input maxlength="200" type="text" name="nama_ibu" required="required" class="form-control" placeholder="Nama Ibu" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        -<input maxlength="100" type="text" name="nomor_ibu" required="required" class="form-control" onKeyPress="return hanyaAngka(event);"
                            placeholder="Masukkan Nomor Handphone" />
                    </div>
                    <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
                </div>
            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="200" type="text" name="nama_wali" required="required" class="form-control" placeholder="Nama Wali" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Pendidikan Wali</label>
                        <select style="height:35px" class="form-control" name="pendidikan_wali" id="pendidikan_wali">
                            <option value="">Pilih</option>
                            <option value="Tidak Sekolah">Tidak Sekolah</option>
                            <option value="SD/MI">SD/MI</option>
                            <option value="SMP/MTs">SMP/MTs</option>
                    ...
                    <div class="form-group">
                        ...
                        <select style="height:35px" class="form-control" name="penghasilan_wali" id="penghasilan_wali">
                            <option value="">Pilih</option>
                            <option value="-500rb">-500rb</option>
                            <option value="500-1jt">500-1jt</option>
                            <option value="1jt-3jt">1jt-3jt</option>
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="100" type="text" name="nomor_wali" required="required" class="form-control" onKeyPress="return hanyaAngka(event);"
                            placeholder="Masukkan Nomor Handphone" />
                    </div>
                    <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
                </div>
            ...
            <div class="col-xs-12">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <input maxlength="200" type="text" name="npsn_sekolah" required="required" class="form-control" placeholder="Masukkan Nomor NPSN Sekolah"
                            onKeyPress="return hanyaAngka(event);" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Asal Sekolah :</label>
                        <input maxlength="200" type="text" name="nama_sekolah" required="required" class="form-control" placeholder="Asal Sekolah" />
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="alamat_sekolah" name="alamat_sekolah" class="form-control" maxlength="100"
                            minlength="3" rows="3" required="required" placeholder="Masukan Alamat Sekolah"></textarea>
                    </div>
                    <div class="form-group">
                        <label class="control-label">Tahun Lulus :</label>
                        <input maxlength="200" type="text" name="tahun_lulus" required="required" class="form-control" placeholder="Tahun Lulus" />
                    </div>
                    <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
                </div>
            </div>
        ...
        <div class="row setup-content" id="step-5">
            <div class="col-xs-12">
                <div class="col-md-12">
                    <h3>Data Nilai Ujian Sekolah</h3>
                    <div class="form-group">
                        <label class="control-label">IPA</label>
                        <input maxlength="200" type="text" name="ipa" required="required" class="form-control" placeholder="Masukkan Nilai"
                            onKeyPress="return hanyaAngka(event);" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Matematika</label>
                        <input maxlength="200" type="text" name="matematika" required="required" class="form-control" placeholder="Masukkan Nilai"
                            onKeyPress="return hanyaAngka(event);" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Bahasa Indonesia</label>
                        <input maxlength="200" type="text" name="indo" required="required" class="form-control" placeholder="Masukkan Nilai"
                            onKeyPress="return hanyaAngka(event);" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">Bahasa Inggris</label>
                        <input maxlength="200" type="text" name="inggris" required="required" class="form-control" placeholder="Masukkan Nilai"
                            onKeyPress="return hanyaAngka(event);" />
                    </div>
                    <button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
                </div>
