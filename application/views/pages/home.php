  ...
  <main id="main">
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 cta-btn-container text-center">
            <a class="cta-btn align-middle" href="#" data-toggle="modal" data-target="#daftarModal" class="btn-get-started scrollto">Daftar</a>
          </div>
        </div>
    ...
    <section id="contact" class="wow fadeInUp">
      ...
      <div class="container mb-4">
        <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15842.875044765957!2d110.1913404!3d-6.9241838!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x9418345c08254aba!2sSMK+Bina+Utama+Kendal!5e0!3m2!1sid!2sid!4v1547650266696" width="100%" height="380" frameborder="0" style="border:0" allowfullscreen></iframe>
      </div>
      ...
      <div class="container">
        <div class="form">
          ...
          <form action="<?php echo base_url('admin/email/kirim'); ?>" method="post" role="form" class="contactForm">
            <div class="form-row">
